...
const flashcardSchema = z.object({
  front_text: z
    ...
    .max(
      VALIDATION_CONSTANTS.FLASHCARD_TEXT_MAX_LENGTH,
      `Front text must not exceed ${VALIDATION_CONSTANTS.FLASHCARD_TEXT_MAX_LENGTH} characters`
    ),
  back_text: z
    .string()
    ...
    .max(
      VALIDATION_CONSTANTS.FLASHCARD_TEXT_MAX_LENGTH,
      `Back text must not exceed ${VALIDATION_CONSTANTS.FLASHCARD_TEXT_MAX_LENGTH} characters`
    ),
});
